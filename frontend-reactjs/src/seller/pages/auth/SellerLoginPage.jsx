...
const SellerLoginPage = () => {
  ...
  // Redirect nếu đã đăng nhập Seller
  useEffect(() => {
  ...
  const handleSendOtp = (e) => {
    ...
    setEmailError("");
    dispatch(sendSellerLoginOtp({ email, isLogin: true }));
    setCountdown(60);
  };
  ...
  const handleLogin = (e) => {
    ...
    dispatch(loginSellerWithOtp({ email, otp }));
  };
    ...
    <div className="dz-auth-page mt-5 -mb-5">
      ...
      <div className="dz-auth-left">
        ...
        <div className="dz-auth-left-inner">
          ...
          <p className="dz-auth-tagline">
            Quản lý cửa hàng <em>dễ dàng</em> cùng DailyZone
          </p>
          <p className="dz-auth-desc">
            Đăng nhập để theo dõi đơn hàng, cập nhật sản phẩm và phát triển doanh số bán hàng của bạn.
          </p>
        </div>
      </div>
      ...
      <div className="dz-auth-right">
        ...
        {!otpSent ? (
          /* ── Bước 1: Email ── */
          <>
            <h1 className="dz-form-heading">Đăng nhập Cửa hàng</h1>
            <p className="dz-form-sub">
              Nhập email tài khoản người bán của bạn, chúng tôi sẽ gửi mã OTP để xác nhận.
            </p>
        ...
        <p className="dz-terms">
          Bằng cách tiếp tục, bạn đồng ý với <a href="#">Điều khoản cho Người Bán</a>{" "}
